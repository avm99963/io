...
// Configuracio:
$folder_octave = "Extres/data_octave/"; // Carpeta on estan les dades per Octave generades
$folder_cc = "Extres/data_cplusplus/"; // Carpeta on estan les dades per C++ generades
